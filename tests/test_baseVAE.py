...
class Test_Model_Building:
    ...
    def test_raises_no_input_dim(self, model_configs_no_input_dim, custom_encoder, custom_decoder):
        ...
        model = BaseVAE(model_configs_no_input_dim, encoder=custom_encoder, decoder=custom_decoder)

        

    def test_build_custom_arch(self, model_config_with_input_dim, custom_encoder, custom_decoder):

        model = BaseVAE(model_config_with_input_dim, encoder=custom_encoder, decoder=custom_decoder)
...
class Test_Model_Saving:
    ...
    def test_custom_encoder_model_saving(self, tmpdir, model_config_with_input_dim, custom_encoder):
    ...
    def test_custom_decoder_model_saving(self, tmpdir, model_config_with_input_dim, custom_decoder):
    ...
    def test_full_custom_model_saving(self, tmpdir, model_config_with_input_dim, custom_encoder, custom_decoder):
    ...
    def test_raises_missing_files(self, tmpdir, model_config_with_input_dim, custom_encoder, custom_decoder):
