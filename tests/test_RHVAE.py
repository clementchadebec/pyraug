...
from pyraug.models.nn.default_architectures import Encoder_MLP, Decoder_MLP, Metric_MLP
from tests.data.rhvae.custom_architectures import Decoder_Conv, Encoder_Conv, NetBadInheritance, Metric_Custom
...
class Test_Build_RHVAE:
    ...
    def test_raises_no_input_dim(self, rhvae_configs_no_input_dim, custom_encoder, custom_decoder, custom_metric):
        ...
        rhvae = RHVAE(rhvae_configs_no_input_dim, encoder=custom_encoder, decoder=custom_decoder, metric=custom_metric)


    def test_build_custom_arch(self, rhvae_config_with_input_dim, custom_encoder, custom_decoder, custom_metric):

        rhvae = RHVAE(rhvae_config_with_input_dim, encoder=custom_encoder, decoder=custom_decoder)
...
class Test_Model_Saving:
    ...
    def test_custom_encoder_model_saving(self, tmpdir, rhvae_config_with_input_dim, custom_encoder):
    ...
    def test_custom_decoder_model_saving(self, tmpdir, rhvae_config_with_input_dim, custom_decoder):
    ...
    def test_custom_metric_model_saving(self, tmpdir, rhvae_config_with_input_dim, custom_metric):
    ...
    def test_full_custom_model_saving(self, tmpdir, rhvae_config_with_input_dim, custom_encoder, custom_decoder, custom_metric):
        
        
        tmpdir.mkdir("dummy_folder")
        dir_path = dir_path = os.path.join(tmpdir, "dummy_folder")

        model = RHVAE(rhvae_config_with_input_dim, encoder=custom_encoder, decoder=custom_decoder, metric=custom_metric)
    ...
    def test_raises_missing_files(self, tmpdir, rhvae_config_with_input_dim, custom_encoder, custom_decoder, custom_metric):
